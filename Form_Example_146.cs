...
// TreeView와 PictureBox를 이용한 역사공부 프로그램
namespace C__200_Example_WinForm
{
    public partial class Form_Example_146 : Form
    {
        public Form_Example_146()
        {
            InitializeComponent();
        }

        private void Form_Example_146_Load(object sender, EventArgs e)
        {
            ...
            TreeNode sachsen = new TreeNode("작센코브르트코타 왕가");
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            ...
            {
                pictureBox1.Image = Bitmap.FromFile("C:/Users/rldns/OneDrive/바탕 화면/Image/excel.png");
                textBox1.Text = "앤 여왕은 1702년 3월 8일 잉글랜드와 스코틀랜드, 아일랜드의 여왕으로 즉위하였습니다.";
            }
            else if (e.Node.Text == "조지 1세(1714~1727)")
            {
                pictureBox1.Image = Bitmap.FromFile("C:/Users/rldns/OneDrive/바탕 화면/Image/ppt.png");
                textBox1.Text = "잉글랜드 의회에서 1701년 왕위결정법이 통과하면서 조지 1세가 왕위에 올랐습니다.";
            }
        }
    }
}
